...
2.  Создание нового приложения на основе холста.
    ...
    -   Нажмите **Создать** и выберите **Приложение \| Приложение на основе холста**.

    -   В приложении на основе холста в пустом окне в поле имени приложения введите **[Ваша фамилия] Охрана кампуса**.

    -   В поле "Формат" выберите **Телефон**.
...
3.  Сохраните приложение на основе холста.
    ...
    -   Проверьте, выбрано ли **Облако**, а затем нажмите **Сохранить**.

    -   Убедитесь, что в качестве имени указано **[Ваша фамилия] Охрана кампуса**, и нажмите **Сохранить**.
