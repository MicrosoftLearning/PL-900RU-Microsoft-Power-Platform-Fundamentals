...
6. Вставьте скопированный ранее URL-адрес в текстовое поле **Ссылка на онлайн-содержимое** и нажмите **Добавить**. Обратите внимание, что если вы скопировали URL-адрес полностью, то протокол https:// будет указан дважды. Убедитесь, что протокол в URL-адресе указан только один раз.
