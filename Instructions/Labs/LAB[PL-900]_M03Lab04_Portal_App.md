...
3.  В области свойств в разделе **Отображение** измените **Имя** с **Новая страница (1)** на `Каталог зданий`.
...
3.  Настройте компонент списка
    ...
    -   В области свойств (справа) введите в поле **Имя** текст `Список зданий`.
